...
$upload_dir = '/uploads/user_uploaded/'; // path from base_url to upload base dir
$current_path = '../../../../../../uploads/user_uploaded/'; // relative path from filemanager folder to upload files folder
